...
class Vae():
    def __init__(self, seed=42, model_name="VAE", num_features=4,
        ...
        self.model = VAE(encoder_neuron_list=[num_features*4, num_features*2, num_features], decoder_neuron_list=[num_features, num_features*2, num_features*4],
                 latent_dim=2, hidden_activation_name=hidden_activation,
                 output_activation_name=output_activation, optimizer_name=optimizer,
                 epoch_num=epochs, batch_size=batch_size, dropout_rate=dropout_rate,
